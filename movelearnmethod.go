...
func (s *MoveLearnMethod) MoveLearnMethodList(ctx context.Context, request operations.MoveLearnMethodListRequest) (*operations.MoveLearnMethodListResponse, error) {
	hookCtx := hooks.HookContext{OperationID: "move-learn-method_list"}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := url.JoinPath(baseURL, "/api/v2/move-learn-method/")
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			var out operations.MoveLearnMethodListResponseBody
...
func (s *MoveLearnMethod) MoveLearnMethodRead(ctx context.Context, request operations.MoveLearnMethodReadRequest) (*operations.MoveLearnMethodReadResponse, error) {
	hookCtx := hooks.HookContext{OperationID: "move-learn-method_read"}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/api/v2/move-learn-method/{id}/", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
