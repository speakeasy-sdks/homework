...
// EvolutionChainBabyTriggerItemItem - The item that a baby Pokémon would be holding when born during a forced evolution
...
func (u *EvolutionChainBabyTriggerItem) UnmarshalJSON(data []byte) error {
	...
	evolutionChainBabyTriggerItemItem := new(EvolutionChainBabyTriggerItemItem)
